...
values
(now(), 0, 11, 7, "opi6@hanmail.net", 0, 0, 0, 1, 0, "인의동큰손", 0, null, null, 30, 15),
...
VALUES
    ...
    ("진짜 노비문서의 위치를 확인할 수 있다.", "item/item3.png", "확실한 정보통", 1000, 1),
    ("먹물을 뿌려 내 화면을 가릴 수 있다.", "item/item4.png", "먹물탄", 1300, 1),
    ("30초간 노비의 위치를 지도에 표시할 수 있다.", "item/item5.png", "조명탄", 1500, 0),
    ("자신이 노비를 잡을 수 있는 범위를 확대할 수 있다.", "item/item6.png", "긴 오랏줄", 2000, 0),
    ("노비 문서의 위치를 셔플할 수 있다.", "item/item7.png", "거짓 정보통", 1000, 0),
